...
import com.cosmicsubspace.nerdyaudio.settings.BooleanElement;
...
import com.cosmicsubspace.nerdyaudio.settings.SpinnerElement;
...
public abstract class FftRenderer extends BaseRenderer {
    public FftRenderer(Context ctxt) {
        ...
        spinnerEntries.add("256");
        mappedValues.add(256);
        spinnerEntries.add("512");
        mappedValues.add(512);
        spinnerEntries.add("1024");
        mappedValues.add(1024);
        spinnerEntries.add("2048");
        mappedValues.add(2048);
        spinnerEntries.add("4096");
        mappedValues.add(4096);
        spinnerEntries.add("8192");
        mappedValues.add(8192);
