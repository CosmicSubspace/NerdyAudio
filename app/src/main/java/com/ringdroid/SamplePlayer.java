//Originally "SamplePlayer" class in the ringdroid source.
//Modified and refactored for use in AFN.
...
import com.cosmicsubspace.nerdyaudio.interfaces.BufferFeedListener;
...
public class SamplePlayer {
    ...
    private BufferFeedListener bfl;
    ...
    public void setBufferFeedListener(BufferFeedListener bfl){
        this.bfl=bfl;
    }
        ...
        mPlayThread = new Thread () {
            public void run() {
                ...
                while (mSamples.position() < limit && mKeepPlaying) {
                    ...
                    Log.v("CS_AFN", "writing to audiotrack" );
                }
            }
        };
        mPlayThread.start();
